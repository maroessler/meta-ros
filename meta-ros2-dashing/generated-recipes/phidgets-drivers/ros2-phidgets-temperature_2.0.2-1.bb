...
# matches with: https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/dashing/phidgets_temperature/2.0.2-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/phidgets_temperature"
SRC_URI = "git://github.com/ros2-gbp/phidgets_drivers-release;${ROS_BRANCH};protocol=https"
SRCREV = "ba4b2eb718af2df81be512b32ca2a7cf8b5ffe52"
S = "${WORKDIR}/git"
