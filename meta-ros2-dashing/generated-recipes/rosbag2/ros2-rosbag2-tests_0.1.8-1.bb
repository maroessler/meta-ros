...
ROS_TEST_DEPENDS = " \
    ...
    ros2-ros2bag \
    ros2-rosbag2 \
    ros2-rosbag2-converter-default-plugins \
...
# matches with: https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_tests/0.1.8-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rosbag2_tests"
SRC_URI = "git://github.com/ros2-gbp/rosbag2-release;${ROS_BRANCH};protocol=https"
SRCREV = "76b61934350017b980ba73af8ee328129d3bc7ad"
S = "${WORKDIR}/git"
