...
# matches with: https://github.com/BehaviorTree/behaviortree_cpp_v3-release/archive/release/dashing/behaviortree_cpp_v3/3.1.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/behaviortree_cpp_v3"
SRC_URI = "git://github.com/BehaviorTree/behaviortree_cpp_v3-release;${ROS_BRANCH};protocol=https"
SRCREV = "8e8f8f7f4a9161cf224f908411cb1eedf0ee6bad"
S = "${WORKDIR}/git"
