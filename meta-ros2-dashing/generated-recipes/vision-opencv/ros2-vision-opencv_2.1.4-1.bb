...
# matches with: https://github.com/ros2-gbp/vision_opencv-release/archive/release/dashing/vision_opencv/2.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/vision_opencv"
SRC_URI = "git://github.com/ros2-gbp/vision_opencv-release;${ROS_BRANCH};protocol=https"
SRCREV = "63db066711e6c0be2372d5914cf30bd3da0e2bdb"
S = "${WORKDIR}/git"
