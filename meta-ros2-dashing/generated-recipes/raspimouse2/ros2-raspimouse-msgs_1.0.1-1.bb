...
# matches with: https://github.com/rt-net/raspimouse2-release/archive/release/dashing/raspimouse_msgs/1.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/raspimouse_msgs"
SRC_URI = "git://github.com/rt-net/raspimouse2-release;${ROS_BRANCH};protocol=https"
SRCREV = "377236efa5bd2f86658a72730b2db586bf7300ab"
S = "${WORKDIR}/git"
