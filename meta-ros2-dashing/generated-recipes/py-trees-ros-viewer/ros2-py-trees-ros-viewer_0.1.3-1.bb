...
# matches with: https://github.com/stonier/py_trees_ros_viewer-release/archive/release/dashing/py_trees_ros_viewer/0.1.3-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/py_trees_ros_viewer"
SRC_URI = "git://github.com/stonier/py_trees_ros_viewer-release;${ROS_BRANCH};protocol=https"
SRCREV = "58e40535e4634ee6c6d81652df200e0e98d0f76f"
S = "${WORKDIR}/git"
