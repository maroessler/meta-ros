...
# matches with: https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_ros_pkgs/3.3.5-3.tar.gz
...
SRCREV = "0606090e2c6346af1ebe8505a9899063a7674bd5"
S = "${WORKDIR}/git"
