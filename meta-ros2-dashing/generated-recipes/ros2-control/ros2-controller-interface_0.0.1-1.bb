...
# matches with: https://github.com/ros2-gbp/ros2_control-release/archive/release/dashing/controller_interface/0.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/controller_interface"
SRC_URI = "git://github.com/ros2-gbp/ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "39a98f1826feedb0e9fec17124b6e2233e41ac53"
S = "${WORKDIR}/git"
