...
# matches with: https://github.com/ros2-gbp/kdl_parser-release/archive/release/dashing/kdl_parser/2.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/kdl_parser"
SRC_URI = "git://github.com/ros2-gbp/kdl_parser-release;${ROS_BRANCH};protocol=https"
SRCREV = "2646106a3450ee62409be118d5b94d084b3d3fdf"
S = "${WORKDIR}/git"
