...
# matches with: https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/dashing/image_transport_plugins/2.1.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/image_transport_plugins"
SRC_URI = "git://github.com/ros2-gbp/image_transport_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "dd57872544e8ef4f91c3febd536f42207c46f3ac"
S = "${WORKDIR}/git"
