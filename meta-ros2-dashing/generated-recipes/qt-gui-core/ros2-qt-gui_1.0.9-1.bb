...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui/1.0.9-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/qt_gui"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "ac8ab99ee12832e3c2041fa8cb731df2b2f51499"
S = "${WORKDIR}/git"
