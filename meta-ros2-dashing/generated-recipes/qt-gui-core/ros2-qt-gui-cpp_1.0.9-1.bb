...
# matches with: https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui_cpp/1.0.9-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/qt_gui_cpp"
SRC_URI = "git://github.com/ros2-gbp/qt_gui_core-release;${ROS_BRANCH};protocol=https"
SRCREV = "33285ecc9f42b4821ce723bab7a9ee4421dedaf4"
S = "${WORKDIR}/git"
