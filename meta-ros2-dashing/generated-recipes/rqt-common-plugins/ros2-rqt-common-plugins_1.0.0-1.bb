...
ROS_EXEC_DEPENDS = " \
    ...
    ros2-rqt-py-common \
    ros2-rqt-py-console \
    ros2-rqt-reconfigure \
    ros2-rqt-service-caller \
    ros2-rqt-shell \
    ros2-rqt-srv \
    ros2-rqt-top \
    ros2-rqt-topic \
...
# matches with: https://github.com/ros2-gbp/rqt_common_plugins-release/archive/release/dashing/rqt_common_plugins/1.0.0-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rqt_common_plugins"
SRC_URI = "git://github.com/ros2-gbp/rqt_common_plugins-release;${ROS_BRANCH};protocol=https"
SRCREV = "c986b9723abf7b951bcc2b4547bc24bb112750db"
S = "${WORKDIR}/git"
