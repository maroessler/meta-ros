...
# matches with: https://github.com/swri-robotics-gbp/marti_common-release/archive/release/dashing/swri_route_util/3.3.0-1.tar.gz
...
SRCREV = "686efc71cd6ce2bc37a519b6ff04739a1e4e504e"
S = "${WORKDIR}/git"
