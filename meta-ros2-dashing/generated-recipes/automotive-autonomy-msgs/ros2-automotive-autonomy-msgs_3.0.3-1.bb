...
ROS_EXEC_DEPENDS = " \
    ros2-automotive-navigation-msgs \
    ros2-automotive-platform-msgs \
"
...
# matches with: https://github.com/astuff/automotive_autonomy_msgs-release/archive/release/dashing/automotive_autonomy_msgs/3.0.3-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/automotive_autonomy_msgs"
SRC_URI = "git://github.com/astuff/automotive_autonomy_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "eab2e1eb489174019cd1d691375a0165ea47670c"
S = "${WORKDIR}/git"
