...
# matches with: https://github.com/ros2-gbp/joint_state_publisher-release/archive/release/dashing/joint_state_publisher/2.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/joint_state_publisher"
SRC_URI = "git://github.com/ros2-gbp/joint_state_publisher-release;${ROS_BRANCH};protocol=https"
SRCREV = "ff23b8ce9c1fcf080ef008f5ed60c0303248b383"
S = "${WORKDIR}/git"
