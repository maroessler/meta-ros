...
# matches with: https://github.com/ros-gbp/teleop_tools-release/archive/release/dashing/teleop_tools_msgs/1.0.2-1.tar.gz
...
SRCREV = "6897cb3df89a5a3ce29ca8e3fe4b6c606f38cd0b"
S = "${WORKDIR}/git"
