...
# matches with: https://github.com/astuff/astuff_sensor_msgs-release/archive/release/dashing/delphi_esr_msgs/3.0.1-1.tar.gz
ROS_BRANCH ?= "branch=release/dashing/delphi_esr_msgs"
SRC_URI = "git://github.com/astuff/astuff_sensor_msgs-release;${ROS_BRANCH};protocol=https"
SRCREV = "bb807b91d97c53747b3ab93ffd7c632f2a7a08ab"
S = "${WORKDIR}/git"
