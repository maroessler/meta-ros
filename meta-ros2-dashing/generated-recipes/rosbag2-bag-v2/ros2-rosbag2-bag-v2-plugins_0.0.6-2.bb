...
ROS_BUILD_DEPENDS = " \
    ...
    ros2-rcutils \
    ros2-ros1-bridge \
    ros2-ros1-rosbag-storage-vendor \
    ros2-rosbag2 \
...
# matches with: https://github.com/ros2-gbp/rosbag2_bag_v2-release/archive/release/dashing/rosbag2_bag_v2_plugins/0.0.6-2.tar.gz
ROS_BRANCH ?= "branch=release/dashing/rosbag2_bag_v2_plugins"
SRC_URI = "git://github.com/ros2-gbp/rosbag2_bag_v2-release;${ROS_BRANCH};protocol=https"
SRCREV = "95f3ce2fa72315d92835158c60d3950a875d8ba1"
S = "${WORKDIR}/git"
