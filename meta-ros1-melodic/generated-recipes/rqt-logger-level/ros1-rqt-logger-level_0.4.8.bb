...
# matches with: https://github.com/ros-gbp/rqt_logger_level-release/archive/release/melodic/rqt_logger_level/0.4.8-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rqt_logger_level"
