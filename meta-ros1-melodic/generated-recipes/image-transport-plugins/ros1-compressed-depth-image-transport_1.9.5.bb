...
# matches with: https://github.com/ros-gbp/image_transport_plugins-release/archive/release/melodic/compressed_depth_image_transport/1.9.5-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/compressed_depth_image_transport"
