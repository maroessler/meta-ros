...
# matches with: https://github.com/pr2-gbp/pr2_common-release/archive/release/melodic/pr2_dashboard_aggregator/1.12.4-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/pr2_dashboard_aggregator"
SRC_URI = "git://github.com/pr2-gbp/pr2_common-release;${ROS_BRANCH};protocol=https"
SRCREV = "ee1d4a8db467bc27f772772d23af1a0fb35a8fea"
S = "${WORKDIR}/git"
