...
# matches with: https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_moveit_config/0.5.13-1.tar.gz
...
SRCREV = "89577f1b18dcaedcd55cebe0e53071fc4dc4a83f"
S = "${WORKDIR}/git"
