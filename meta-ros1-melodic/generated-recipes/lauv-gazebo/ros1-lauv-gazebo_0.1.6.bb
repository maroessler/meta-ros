...
# matches with: https://github.com/uuvsimulator/lauv_gazebo-release/archive/release/melodic/lauv_gazebo/0.1.6-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/lauv_gazebo"
