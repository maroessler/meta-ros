...
# matches with: https://github.com/uuvsimulator/uuv_simulator-release/archive/release/melodic/uuv_world_ros_plugins/0.6.13-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/uuv_world_ros_plugins"
