...
ROS_BUILD_DEPENDS = " \
    ...
    ros1-pluginlib \
    ros1-roscpp \
    ros1-usb-cam-hardware-interface \
"
...
# matches with: https://github.com/yoshito-n-students/usb_cam_hardware-release/archive/release/melodic/usb_cam_hardware/0.0.4-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/usb_cam_hardware"
SRC_URI = "git://github.com/yoshito-n-students/usb_cam_hardware-release;${ROS_BRANCH};protocol=https"
SRCREV = "e2f7b7a6ff511ff5f4dc3f2c784a210dc607cf99"
S = "${WORKDIR}/git"
