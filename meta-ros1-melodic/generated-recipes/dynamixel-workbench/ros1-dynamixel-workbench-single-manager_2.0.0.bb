...
# matches with: https://github.com/ROBOTIS-GIT-release/dynamixel-workbench-release/archive/release/melodic/dynamixel_workbench_single_manager/2.0.0-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/dynamixel_workbench_single_manager"
