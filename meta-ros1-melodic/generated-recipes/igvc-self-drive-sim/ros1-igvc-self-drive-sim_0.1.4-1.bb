...
# matches with: https://github.com/robustify/igvc_self_drive_sim-release/archive/release/melodic/igvc_self_drive_sim/0.1.4-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/igvc_self_drive_sim"
