...
# matches with: https://github.com/DataspeedInc-release/dbw_mkz_ros-release/archive/release/melodic/dbw_mkz_description/1.2.3-1.tar.gz
...
SRCREV = "68379a1d6cfb83cc9ab68ee89768f6a1bffb670f"
S = "${WORKDIR}/git"
