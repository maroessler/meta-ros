...
# matches with: https://github.com/yujinrobot-release/rocon_tools-release/archive/release/melodic/rocon_console/0.3.2-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rocon_console"
