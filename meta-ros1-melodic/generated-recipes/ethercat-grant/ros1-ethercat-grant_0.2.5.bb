...
# matches with: https://github.com/shadow-robot/ethercat_grant-release/archive/release/melodic/ethercat_grant/0.2.5-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/ethercat_grant"
