...
# matches with: https://github.com/UbiquityRobotics-release/fiducials-release/archive/release/melodic/fiducials/0.11.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/fiducials"
