...
# matches with: https://github.com/ros-industrial-release/ros_canopen-release/archive/release/melodic/canopen_chain_node/0.8.2-1.tar.gz
...
SRCREV = "8580842887b4d190761b8e6f26a32679481f08a6"
S = "${WORKDIR}/git"
