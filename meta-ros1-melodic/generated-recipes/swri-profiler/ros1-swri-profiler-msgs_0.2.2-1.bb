...
# matches with: https://github.com/swri-robotics-gbp/swri_profiler-release/archive/release/melodic/swri_profiler_msgs/0.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/swri_profiler_msgs"
