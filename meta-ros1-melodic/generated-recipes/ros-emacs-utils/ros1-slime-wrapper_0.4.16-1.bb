...
# matches with: https://github.com/code-iai-release/ros_emacs_utils-release/archive/release/melodic/slime_wrapper/0.4.16-1.tar.gz
...
SRCREV = "10b7ca2906b0f344784ee4307fe936db2434fe1f"
S = "${WORKDIR}/git"
