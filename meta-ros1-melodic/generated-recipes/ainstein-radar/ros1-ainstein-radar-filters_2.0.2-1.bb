...
# matches with: https://github.com/AinsteinAI/ainstein_radar-release/archive/release/melodic/ainstein_radar_filters/2.0.2-1.tar.gz
...
SRCREV = "698077571ed6785593171f1277832e9fca4db3cf"
S = "${WORKDIR}/git"
