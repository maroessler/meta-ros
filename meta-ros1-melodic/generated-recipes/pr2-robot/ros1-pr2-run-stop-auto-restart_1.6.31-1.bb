...
# matches with: https://github.com/pr2-gbp/pr2_robot-release/archive/release/melodic/pr2_run_stop_auto_restart/1.6.31-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/pr2_run_stop_auto_restart"
SRC_URI = "git://github.com/pr2-gbp/pr2_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "0a0585196a9ccc24d2672758a542f69df66de047"
S = "${WORKDIR}/git"
