...
# matches with: https://github.com/pr2-gbp/pr2_robot-release/archive/release/melodic/pr2_controller_configuration/1.6.31-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/pr2_controller_configuration"
SRC_URI = "git://github.com/pr2-gbp/pr2_robot-release;${ROS_BRANCH};protocol=https"
SRCREV = "584c954adebf4ec1a53c0cd3dde32025b640cdc4"
S = "${WORKDIR}/git"
