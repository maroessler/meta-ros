...
ROS_EXEC_DEPENDS = " \
    ros1-rotors-comm \
    ros1-rotors-control \
    ros1-rotors-description \
    ros1-rotors-evaluation \
    ros1-rotors-gazebo \
...
# matches with: https://github.com/ethz-asl/rotors_simulator-release/archive/release/melodic/rotors_simulator/2.2.3-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rotors_simulator"
SRC_URI = "git://github.com/ethz-asl/rotors_simulator-release;${ROS_BRANCH};protocol=https"
SRCREV = "feea348076bcdf1179d58cab27a9ad9f58ded221"
S = "${WORKDIR}/git"
