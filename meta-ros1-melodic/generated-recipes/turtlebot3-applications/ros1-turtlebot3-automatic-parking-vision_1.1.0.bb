...
# matches with: https://github.com/ROBOTIS-GIT-release/turtlebot3_applications-release/archive/release/melodic/turtlebot3_automatic_parking_vision/1.1.0-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/turtlebot3_automatic_parking_vision"
