...
# matches with: https://github.com/ROBOTIS-GIT-release/hls-lfcd-lds-driver-release/archive/release/melodic/hls_lfcd_lds_driver/1.1.1-1.tar.gz
...
SRCREV = "1549c0758f5818027f72cd80d67d5e2e003bfadb"
S = "${WORKDIR}/git"
