...
# matches with: https://github.com/JdeRobot/drones-release/archive/release/melodic/rqt_drone_teleop/1.3.2-5.tar.gz
...
SRCREV = "ccc3e6c71b0d91a6e1e22228f929558fb75984d3"
S = "${WORKDIR}/git"
