...
# matches with: https://github.com/xqms/rosbag_fancy-release/archive/release/melodic/rosbag_fancy/0.2.0-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosbag_fancy"
SRC_URI = "git://github.com/xqms/rosbag_fancy-release;${ROS_BRANCH};protocol=https"
SRCREV = "ccecd65a647d3df17821accb2228e56cae5b2a35"
S = "${WORKDIR}/git"
