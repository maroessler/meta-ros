...
# matches with: https://github.com/rohbotics/xv_11_laser_driver-release/archive/release/melodic/xv_11_laser_driver/0.3.0-0.tar.gz
ROS_BRANCH ?= "branch=release/melodic/xv_11_laser_driver"
