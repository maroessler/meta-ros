...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_core_task_maps/5.1.2-1.tar.gz
...
SRCREV = "e6d0343423bd83a208a9e851a5db26678630fabe"
S = "${WORKDIR}/git"
