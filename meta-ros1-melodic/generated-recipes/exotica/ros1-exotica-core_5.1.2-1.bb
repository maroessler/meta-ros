...
# matches with: https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_core/5.1.2-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/exotica_core"
SRC_URI = "git://github.com/ipab-slmc/exotica-release;${ROS_BRANCH};protocol=https"
SRCREV = "fb62247e6a92c0d7c88ecf26d5ceaf7a1848a67f"
S = "${WORKDIR}/git"
