...
# matches with: https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosservice/1.14.6-1.tar.gz
ROS_BRANCH ?= "branch=release/melodic/rosservice"
SRC_URI = "git://github.com/ros-gbp/ros_comm-release;${ROS_BRANCH};protocol=https"
SRCREV = "b5838e4e3cf15f31ac2b6beeed514277529da1b4"
S = "${WORKDIR}/git"
